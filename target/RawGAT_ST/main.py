...
if __name__ == '__main__':
    ...
    parser.add_argument('--protocols_path', type=str, default='/home/dslab/hx/vfuzz/media/data/LA/ASVspoof2019_LA_cm_protocols/', help='Change with path to user\'s LA database protocols directory address')
    '''
    % protocols_path/
